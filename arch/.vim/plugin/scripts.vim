...
let g:ale_linters = {'jsx': ['prettier', 'tsserver', 'eslint']}
let g:ale_linters_ignore = { 'python': ['pylint', 'mypy', 'flake8'], }
let g:ale_linters = { 'python': ['ruff', 'pyright' ], }
let g:ale_fixers = { '*': ['remove_trailing_lines', 'trim_whitespace'], 'python': ['black'], 'javascript': ['prettier', 'eslint'], 'javascript.jsx': ['prettier', 'tsserver'],}
let g:ale_linter_aliases = {'typescriptreact': 'typescript'}
let g:ale_fix_on_save = 1
let g:ale_set_highlights = 1
highlight ALEWarning guifg=#eeeeee guibg=#e9ad0c gui=reverse cterm=reverse,italic
highlight ALEError guifg=#eeeeee guibg=#c01c28 gui=reverse cterm=reverse,italic
