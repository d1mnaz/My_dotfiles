...
hi Normal guifg=#414141 guibg=#ffffff gui=NONE cterm=NONE
hi Folded guifg=#414141 guibg=#dadada gui=NONE cterm=NONE
...
hi QuickFixLine guifg=#f0f0f0 guibg=#a8a8a8 gui=NONE cterm=NONE
hi StatusLine guifg=#ffffff guibg=#838383 gui=bold cterm=bold
...
hi NonText guifg=#a8a8a8 guibg=#ffffff gui=NONE cterm=NONE
...
hi Underlined guifg=#838383 guibg=NONE gui=underline cterm=underline
hi Error guifg=#dadada guibg=#ffffff gui=reverse cterm=reverse
hi WarningMsg guifg=#414141 guibg=#ffffff gui=NONE cterm=NONE
hi MoreMsg guifg=#414141 guibg=#ffffff gui=NONE cterm=NONE
hi ModeMsg guifg=#000000 guibg=#ffffff gui=NONE cterm=NONE
hi Question guifg=#414141 guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#000000 guibg=#ffff00 gui=NONE cterm=NONE
hi MatchParen guifg=#ffffff guibg=#979797 gui=bold cterm=bold
hi Search guifg=#ffffff guibg=#979797 gui=NONE cterm=NONE
hi IncSearch guifg=#404040 guibg=#f0f0f0 gui=reverse cterm=reverse
hi WildMenu guifg=#404040 guibg=#f0f0f0 gui=bold cterm=bold
hi ColorColumn guifg=#979797 guibg=#f0f0f0 gui=NONE cterm=NONE
hi Cursor guifg=#ffffff guibg=#979797 gui=NONE cterm=NONE
hi lCursor guifg=#000000 guibg=#a07070 gui=NONE cterm=NONE
hi SpellBad guifg=#414141 guibg=NONE guisp=#ff0000 gui=undercurl cterm=underline
hi SpellCap guifg=#414141 guibg=NONE guisp=#2e8b57 gui=undercurl cterm=underline
hi SpellLocal guifg=#414141 guibg=NONE guisp=#ff00ff gui=undercurl cterm=underline
hi SpellRare guifg=#414141 guibg=NONE guisp=#00008b gui=undercurl cterm=underline
hi Statement guifg=#363636 guibg=NONE gui=bold cterm=bold
hi Type guifg=#979797 guibg=NONE gui=None cterm=None
hi Comment guifg=#a8a8a8 guibg=NONE gui=bold cterm=italic
hi StorageClass guifg=#ff0000 guibg=NONE gui=bold cterm=bold
hi Conceal guifg=#dadada guibg=#767676 gui=NONE cterm=NONE
hi Identifier guifg=#000000 guibg=NONE gui=bold cterm=bold
" hi Function guifg=#7b7b7b guibg=NONE gui=bold cterm=bold
hi Constant guifg=#404040 guibg=NONE gui=italic cterm=italic
hi Number guifg=#414141 guibg=NONE gui=bold cterm=bold
...
hi PreProc guifg=#4f4f4f guibg=NONE gui=bold cterm=bold
hi Function guifg=#2a2a2a guibg=NONE gui=bold cterm=bold
hi htmlTag            guifg=#4f4f4f gui=NONE cterm=bold
hi htmlSpecialTagName guifg=#4f4f4f gui=NONE cterm=bold
hi htmlTagName        guifg=#4f4f4f gui=NONE cterm=bold
hi htmlEndTag         guifg=#4f4f4f gui=NONE cterm=bold
