...
local function worker(user_args)
    ...
    local play_icon = args.play_icon or '/usr/share/icons/Arc/actions/16/player_play.png'
    local pause_icon = args.pause_icon or '/usr/share/icons/Arc/actions/16/player_pause.png'
