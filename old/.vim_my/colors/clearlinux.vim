...
hi clear
let g:colors_name = 'clearlinux'
let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 1
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#202020', '#c01c28', '#26a269', '#a2734c', '#12488b', '#a347ba', '#2aa1b3', '#d0cfcc', '#5e5c64', '#f66151', '#33da7a', '#e9ad0c', '#2a7bde', '#c061cb', '#33c7de', '#e0e0ed']
endif
...
hi Normal guifg=#e0e0ed guibg=#202020 gui=NONE cterm=NONE
hi Terminal guifg=#e0e0ed guibg=#202020 gui=NONE cterm=NONE
hi Statusline guifg=#ffffff guibg=#d0cfcc gui=NONE cterm=NONE
hi StatuslineNC guifg=#ffffff guibg=#5e5c64 gui=NONE cterm=NONE
hi StatuslineTerm guifg=#ffffff guibg=#d0cfcc gui=NONE cterm=NONE
hi StatuslineTermNC guifg=#ffffff guibg=#5e5c64 gui=NONE cterm=NONE
hi VertSplit guifg=#5e5c64 guibg=#5e5c64 gui=NONE cterm=NONE
hi TabLine guifg=#ffffff guibg=#5e5c64 gui=NONE cterm=NONE
hi TabLineFill guifg=#ffffff guibg=#5e5c64 gui=NONE cterm=NONE
hi TabLineSel guifg=NONE guibg=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold
hi ToolbarLine guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi ToolbarButton guifg=#d0cfcc guibg=#202020 gui=bold,reverse cterm=bold,reverse
hi QuickFixLine guifg=#ffffff guibg=#2a7bde gui=NONE cterm=NONE
hi CursorLineNr guifg=#a2734c guibg=NONE gui=bold cterm=bold
...
hi Visual guifg=#ffffff guibg=#5e5c64 gui=NONE cterm=NONE
hi VisualNOS guifg=#ffffff guibg=#8787ff gui=NONE cterm=NONE
hi Pmenu guifg=NONE guibg=#262626 gui=NONE cterm=NONE
hi PmenuThumb guifg=NONE guibg=#5e5c64 gui=NONE cterm=NONE
hi PmenuSbar guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi PmenuSel guifg=#ffffff guibg=#e9ad0c gui=NONE cterm=NONE
hi SignColumn guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Error guifg=#c01c28 guibg=#202020 gui=reverse cterm=reverse
hi ErrorMsg guifg=#c01c28 guibg=#202020 gui=reverse cterm=reverse
hi ModeMsg guifg=#ffffff guibg=#e9ad0c gui=NONE cterm=NONE
hi MoreMsg guifg=#26a269 guibg=NONE gui=NONE cterm=NONE
hi Question guifg=#d7d700 guibg=NONE gui=NONE cterm=NONE
hi WarningMsg guifg=#c01c28 guibg=NONE gui=NONE cterm=NONE
hi Todo guifg=#a2734c guibg=#202020 gui=reverse cterm=reverse
hi MatchParen guifg=#a347ba guibg=NONE gui=bold cterm=NONE
hi Search guifg=#ffffff guibg=#26a269 gui=NONE cterm=NONE
hi IncSearch guifg=#ffffff guibg=#e9ad0c gui=NONE cterm=NONE
hi CurSearch guifg=#ffffff guibg=#a2734c gui=NONE cterm=NONE
hi WildMenu guifg=#ffffff guibg=#e9ad0c gui=NONE cterm=NONE
hi debugPC guifg=#ffffff guibg=#8787ff gui=NONE cterm=NONE
hi debugBreakpoint guifg=#202020 guibg=#c01c28 gui=NONE cterm=NONE
hi Cursor guifg=#ffffff guibg=#a2734c gui=NONE cterm=NONE
hi lCursor guifg=#ffffff guibg=#31a354 gui=NONE cterm=NONE
hi CursorLine guifg=NONE guibg=#303030 gui=NONE cterm=NONE
hi CursorColumn guifg=NONE guibg=#303030 gui=NONE cterm=NONE
hi Folded guifg=#d0cfcc guibg=#262626 gui=NONE cterm=NONE
hi ColorColumn guifg=NONE guibg=#262626 gui=NONE cterm=NONE
hi SpellBad guifg=NONE guibg=NONE guisp=#c01c28 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
hi SpellCap guifg=NONE guibg=NONE guisp=#8787ff gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
hi SpellLocal guifg=NONE guibg=NONE guisp=#26a269 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
hi SpellRare guifg=NONE guibg=NONE guisp=#a347ba gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
hi Comment guifg=#5e5c64 guibg=NONE gui=NONE cterm=NONE
hi Constant guifg=#c01c28 guibg=NONE gui=NONE cterm=NONE
hi String guifg=#26a269 guibg=NONE gui=NONE cterm=NONE
hi Character guifg=#31a354 guibg=NONE gui=NONE cterm=NONE
hi Identifier guifg=#2a7bde guibg=NONE gui=NONE cterm=NONE
hi Statement guifg=#c061cb guibg=NONE gui=NONE cterm=NONE
hi PreProc guifg=#d7d700 guibg=NONE gui=NONE cterm=NONE
hi Type guifg=#8787ff guibg=NONE gui=NONE cterm=NONE
hi Special guifg=#2a7bde guibg=NONE gui=NONE cterm=NONE
hi Underlined guifg=NONE guibg=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline
hi Title guifg=#a2734c guibg=NONE gui=bold cterm=bold
hi Directory guifg=#8787ff guibg=NONE gui=bold cterm=bold
hi Conceal guifg=#5e5c64 guibg=NONE gui=NONE cterm=NONE
hi Ignore guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
hi Debug guifg=#8787ff guibg=NONE gui=NONE cterm=NONE
hi DiffAdd guifg=#ffffff guibg=#26a269 gui=NONE cterm=NONE
hi DiffDelete guifg=#a2734c guibg=NONE gui=NONE cterm=NONE
hi diffAdded guifg=#26a269 guibg=NONE gui=NONE cterm=NONE
hi diffRemoved guifg=#c01c28 guibg=NONE gui=NONE cterm=NONE
hi diffSubname guifg=#c061cb guibg=NONE gui=NONE cterm=NONE
hi DiffText guifg=#ffffff guibg=#dfdfdf gui=NONE cterm=NONE
hi DiffChange guifg=#ffffff guibg=#afafaf gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi MatchParen ctermfg=66 ctermbg=NONE cterm=None
