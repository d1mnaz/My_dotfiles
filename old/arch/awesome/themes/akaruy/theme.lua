...
themes_dir                          = os.getenv("HOME") .. "/.config/awesome/themes/akaruy"
--theme.wallpaper                     = themes_dir .. "/black-and-white-dragon.jpg"
theme.wallpaper                     = themes_dir .. "/tree.jpg"
--theme.font                          = " PT Serif 9"
theme.font                          = "Underdog 12"
theme.fg_normal                     = "#161619"
...
--theme.fg_focus      = "#04378a"
theme.fg_focus      = "#191919"
theme.fg_urgent     = "#000000"
theme.fg_minimize  = "#dcdddd"
theme.bg_normal     = "#ffffff"
--theme.bg_focus      = "#B3B4B3"
theme.bg_focus      = "#cecece"
